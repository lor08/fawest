...
class News extends Model implements AttachableInterface
{
    use AttachableTrait;
     ...
     */
    protected $fillable = [
        'name', 'slug', 'category_id', 'note', 'description', 'status', 'artikul', 'views', 'show', 'complected', 'complect_id'
    ];
    ...
    {
        return $this->belongsToMany('App\Models\NewsCategory', 'news_categories_news', 'news_id', 'category_id');
    }
